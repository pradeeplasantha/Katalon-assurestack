...
WebUI.verifyElementText(findTestObject('Page_Assure Stack Analytics/INSPECTIONS WITH MOST FLAGGED RESPONSES Text'), 'INSPECTIONS WITH MOST FLAGGED RESPONSES')

WebUI.scrollToElement(findTestObject('Page_Assure Stack Analytics/INSPECTIONS WITH MOST FLAGGED RESPONSES Text'), 0)

WebUI.verifyElementText(findTestObject('Page_Assure Stack Analytics/Inspections With Most Flagged Responses Table as CSV Button'), 
    'Table as CSV')

WebUI.verifyElementVisible(findTestObject('Page_Assure Stack Analytics/Inspections With Most Flagged Responses Table as CSV Button'))

WebUI.verifyElementClickable(findTestObject('Page_Assure Stack Analytics/Inspections With Most Flagged Responses Table as CSV Button'))

String filePathToDelete = 'C:\\Users\\pcadmin\\Downloads\\most-flagged-audits.xlsx'
...
WebUI.click(findTestObject('Page_Assure Stack Analytics/Inspections With Most Flagged Responses Table as CSV Button'))

WebUI.delay(10)

String downloadPath = 'C:\\Users\\pcadmin\\Downloads'

String fileName = 'most-flagged-audits.xlsx'
