...
WebUI.verifyElementText(findTestObject('Page_Assure Stack Analytics/Sites Text'), 'Sites')

WebUI.click(findTestObject('Filter Selection/Site Selection'))

WebUI.click(findTestObject('Page_Assure Stack Analytics/Site First site'))
...
String folderPath = relativePath + '\\Test Cases Screenshots\\Sites Filter\\Single Selection'
...
WebUI.takeScreenshot(relativePath + '\\Test Cases Screenshots\\Sites Filter\\Single Selection\\Sites_Filter.png')
...
WebUI.takeScreenshot(relativePath + '\\Test Cases Screenshots\\Sites Filter\\Single Selection\\Audits_Conducted_Bar_Chart.png')
...
WebUI.takeScreenshot(relativePath + '\\Test Cases Screenshots\\Sites Filter\\Single Selection\\Inspections_Performance_Bar_Chart.png')
