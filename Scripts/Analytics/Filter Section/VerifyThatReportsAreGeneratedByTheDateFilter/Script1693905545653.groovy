...
String folderPath = relativePath + '\\Test Cases Screenshots\\Date Filter'
...
WebUI.takeScreenshot(relativePath + '\\Test Cases Screenshots\\Date Filter\\Date_Filter.png')
...
WebUI.takeScreenshot(relativePath + '\\Test Cases Screenshots\\Date Filter\\Audits_Conducted_Bar_Chart.png')
...
WebUI.takeScreenshot(relativePath + '\\Test Cases Screenshots\\Date Filter\\Inspections_Performance_Bar_Chart.png')
