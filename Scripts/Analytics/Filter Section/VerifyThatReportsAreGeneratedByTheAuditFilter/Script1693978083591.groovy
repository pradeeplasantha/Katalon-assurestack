...
WebUI.verifyElementText(findTestObject('Page_Assure Stack Analytics/Audit Text'), 'Audit')

WebUI.click(findTestObject('Filter Selection/Audit Selection'))

WebUI.click(findTestObject('Page_Assure Stack Analytics/Audit Pradeep DX'))

WebUI.click(findTestObject('Page_Assure Stack Analytics/Date Text'))
...
String folderPath = relativePath + '\\Test Cases Screenshots\\Audit Filter\\Single Selection'
...
WebUI.takeScreenshot(relativePath + '\\Test Cases Screenshots\\Audit Filter\\Single Selection\\Audit_Filter.png')
...
WebUI.takeScreenshot(relativePath + '\\Test Cases Screenshots\\Audit Filter\\Single Selection\\Audits_Conducted_Bar_Chart.png')
...
WebUI.takeScreenshot(relativePath + '\\Test Cases Screenshots\\Audit Filter\\Single Selection\\Inspections_Performance_Bar_Chart.png')
