...
WebUI.verifyElementText(findTestObject('Page_Assure Stack Analytics/Finished By Text'), 'Finished By')

WebUI.click(findTestObject('Filter Selection/Finished By Selection'))

WebUI.click(findTestObject('Page_Assure Stack Analytics/Finished By Pradeep lasantha'))
...
String folderPath = relativePath + '\\Test Cases Screenshots\\Finished By Filter'
...
WebUI.takeScreenshot(relativePath + '\\Test Cases Screenshots\\Finished By Filter\\Finished_By_Filter.png')
...
WebUI.takeScreenshot(relativePath + '\\Test Cases Screenshots\\Finished By Filter\\Audits_Conducted_Bar_Chart.png')
...
WebUI.takeScreenshot(relativePath + '\\Test Cases Screenshots\\Finished By Filter\\Inspections_Performance_Bar_Chart.png')
