...
'Email'
WebUI.setText(findTestObject('Object Repository/Page_Assure Stack Login/Input Email'), 'pradeep@dxdy.tech')

'Password'
WebUI.setText(findTestObject('Object Repository/Page_Assure Stack Login/Input Password'), 'Lasa99**')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Assure Stack Subscription Plans/Welcome Text'), 'Welcome Back, Pradeep Lasantha, Admin')
