...
'Email'
WebUI.setText(findTestObject('Object Repository/Page_Assure Stack Login/Input Email'), 'pradeepnjnjo@dxdy.tech')

'Password'
WebUI.setText(findTestObject('Object Repository/Page_Assure Stack Login/Input Password'), 'Lasa99uhu')
...
WebUI.verifyElementText(findTestObject('Page_Assure Stack Login/Email Is Invalid Or Not Found Text'), 'Email is invalid or not found')
