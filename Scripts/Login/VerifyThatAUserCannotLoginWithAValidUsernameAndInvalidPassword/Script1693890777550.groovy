...
'Password'
WebUI.setText(findTestObject('Object Repository/Page_Assure Stack Login/Input Password'), 'Lasa9989889')
...
WebUI.verifyElementText(findTestObject('Page_Assure Stack Login/Password Is Incorrect Text'), 'Password is incorrect')
